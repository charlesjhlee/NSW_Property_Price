...
foldername = 'nsw_data_current2'
filename = 'current_nsw_data.csv'

if os.path.exists("C:\\Users\\LEEJNC\\Google Drive\\Property\\"+foldername):
    os.chdir("C:\\Users\\LEEJNC\\Google Drive\\Property\\"+foldername)
else:
    os.chdir("C:\\Users\\LEEJNC\\Google Drive\\Property")    
